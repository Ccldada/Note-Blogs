import{_ as s,c as i,o as a,a3 as n}from"./chunks/framework.DWT__QHq.js";const c=JSON.parse('{"title":"对象版本","description":"","frontmatter":{},"headers":[],"relativePath":"Notes/14_other/websocket.md","filePath":"Notes/14_other/websocket.md"}'),l={name:"Notes/14_other/websocket.md"},h=n(`<h1 id="对象版本" tabindex="-1">对象版本 <a class="header-anchor" href="#对象版本" aria-label="Permalink to &quot;对象版本&quot;">​</a></h1><div class="language-less vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">less</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 信息提示</span></span>
